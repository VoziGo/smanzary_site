...
rclone copy -P --max-depth 1 --drive-chunk-size 64M "$DB_BACKUP_DIR" gdrive:backups/smanzary_site/backups/
rclone copy -P --max-depth 1 --drive-chunk-size 64M "$UPLOADS_DIR" gdrive:backups/smanzary_site/uploads/
